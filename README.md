...
* **Tasks:**
    * Initialize .NET Web API project and local Git repository.
    * Configure `HttpClient` factory in C# to consume OpenF1 endpoints.
    * Create basic JSON-to-C# DTOs (Data Transfer Objects) for Driver and Session data.
...
* **Tasks:**
    * Implement an **Abstraction Layer**: The frontend should never call OpenF1 directly; it calls *my* API.
    ...
    * **Milestone:** Functional API endpoints (e.g., `/api/race/standings`) returning cleaned, optimized data.
